...
class FitSphericalEllipse():
    ...
    def __init__(self, edge_coords, skycoord_init, semi_major_init, semi_minor_init, theta_init):
        ...
        skycoord0 : astropy.coordinates.SkyCoord
            The initial guess for the center of the localization region.
        a0 : float
    ...
    def generate_spherical_ellipse(lon, lat, a, b, theta, npoints = 100):
        ...
        # I kept this variable assignment to avoid changing the code below and remind myself that lon, lat and theta are in radians.
        lon_rad = lon
        ...
        # the sky coordinates in degrees
    ...
    def construct_R(lon, polar, theta):
        ...
        # I decided to use radians internally, so conversion is not need
        # I kept this variable assignment to avoid changing the rotation matrix below and remind myself that lon, lat and theta are in radians.
        lon_rad = lon
        polar_rad = polar
        theta_rad = theta
    ...
    def construct_Q(lon, polar, a, b, theta):
        ...
        """
        Construct the matrix of the quadratic form, Q, from the ellipse parameters.
